...
public class MultiStateView extends FrameLayout {
    ...
    public static final int VIEW_STATE_CENTER = 4;

    @Retention(RetentionPolicy.SOURCE)
    @IntDef({VIEW_STATE_CONTENT, VIEW_STATE_ERROR, VIEW_STATE_EMPTY, VIEW_STATE_LOADING, VIEW_STATE_CENTER})
    ...
    private void init(AttributeSet attrs) {
        ...
        int centerViewResId = a.getResourceId(R.styleable.MultiStateView_msv_centerView, -1);
        if (centerViewResId > -1) {
            mCenterView = mInflater.inflate(centerViewResId, this, false);
            addView(mCenterView, mCenterView.getLayoutParams());
        }
...
//                    throw new NullPointerException("center View");
    ...
    private boolean isValidContentView(View view) {
        ...
        return view != mLoadingView && view != mErrorView && view != mEmptyView && view!=mCenterView;
    }
    ...
    public void setViewForState(View view, @ViewState int state, boolean switchToState) {
        switch (state) {
            ...
            case VIEW_STATE_CENTER:
                if (mCenterView != null) removeView(mCenterView);
                mCenterView = view;
                addView(mCenterView);
                break;
        }
