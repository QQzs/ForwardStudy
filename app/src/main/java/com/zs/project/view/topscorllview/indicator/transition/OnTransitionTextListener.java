package com.zs.project.view.topscorllview.indicator.transition;
...
import com.zs.project.view.topscorllview.indicator.Indicator;
import com.zs.project.view.topscorllview.utils.ColorGradient;
...
public class OnTransitionTextListener implements Indicator.OnTransitionListener {
	...
	public View getView(View tabItemView, int position){
		return tabItemView;
	}
