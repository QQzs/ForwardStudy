package com.zs.project.view.topscorllview.indicator;
...
public class ScrollIndicatorView extends HorizontalScrollView implements Indicator {
    ...
    /**
     * 当第一个tab滑出，是否显示快捷返回的tab
     * @param isPinnedTabView
     */
...
//        setPinnedTabBg(new ColorDrawable(color));
        setPinnedTabBg(new ColorDrawable(ContextCompat.getColor(getContext(), color)));

    }

    /**
     * 设置固定在第一位tab的背景颜色
     * @param pinnedTabBgDrawableId
     */
