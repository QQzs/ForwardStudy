package com.zs.project.view.swipecard;
...
import static com.zs.project.view.swipecard.CardConfig.MAX_SHOW_COUNT;
import static com.zs.project.view.swipecard.CardConfig.SCALE_GAP;
import static com.zs.project.view.swipecard.CardConfig.TRANS_Y_GAP;
...
public class RenRenCallback extends ItemTouchHelper.SimpleCallback {
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        mDatas.add(0, remove);
//        mDatas.add(mDatas.size() - 1, remove);
